...
-- TODO
SELECT * FROM fireIncidents WHERE `Incident Date` LIKE '09/27%' OR `Incident Date` = '04/04/2016';
...
-- TODO
SELECT * FROM fireIncidents WHERE (`Incident Date` LIKE '09/27%' OR `Incident Date` = '04/04/2016') AND `Station Area` > 20; 
...
-- TODO
SELECT COUNT(`Incident Number`) FROM fireIncidents WHERE `Incident Date` = '04/04/2016';
...
-- TODO
SELECT `Ignition Cause`, COUNT(`Call Number`) AS NUMBER_OF_FIRE_CALLS FROM fireIncidents GROUP BY `Ignition Cause`
...
-- TODO
SELECT `Ignition Cause`, COUNT(`Call Number`) AS NUMBER_OF_FIRE_CALLS FROM fireIncidents GROUP BY `Ignition Cause` ORDER BY NUMBER_OF_FIRE_CALLS ASC
...
-- TODO
SELECT `Ignition Cause`, COUNT(`Call Number`) AS NUMBER_OF_FIRE_CALLS FROM fireIncidents GROUP BY `Ignition Cause` ORDER BY NUMBER_OF_FIRE_CALLS DESC
...
-- TODO
SELECT * FROM fireIncidents INNER JOIN fireCalls ON fireIncidents.`Incident Number` = fireCalls.`Incident Number`
