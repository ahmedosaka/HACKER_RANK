...
SELECT `Call_Type_Group`, COUNT(*) Count 
...
CREATE OR REPLACE TEMPORARY VIEW fireCallsGroupCleaned AS
SELECT * FROM fireCallsClean
...
WHERE `Call_Type_Group` = 'Potentially Life-Threatening' OR `Call_Type_Group` = 'Non Life-threatening'
...
-- MAGIC print(sql("SELECT * FROM testTable"))
